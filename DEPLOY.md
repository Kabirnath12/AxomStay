...
5. Set Cashfree's return URL/domain settings to the deployed domain before accepting live payments.
...
Never commit `.env`, Cashfree keys, Twilio tokens, Google secrets, or real customer data.
